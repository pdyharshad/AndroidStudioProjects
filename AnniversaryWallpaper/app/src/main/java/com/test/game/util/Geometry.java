...
import static com.test.game.util.Geometry.vectorBetween;
...
public class Geometry {
    ...
    public static boolean intersects(Sphere sphere, Ray ray) {
        Log.w(TAG, "Distance:" + distanceBetween(sphere.center, ray) + "\n"+"Radius:  "+ sphere.radius );
...
// of this triangle is the distance from the point to the ray.
    ...
    public static class Arc {
        ...
        public final float fromAngle;

        public Arc(Point center, float radius, float angle, float fromAngle) {
            this.center = center;
            this.radius = radius;
            this.angle = angle;
